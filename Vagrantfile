...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  # Foreman Server
  config.vm.define "nodename1".to_sym do |nodename1|
    nodename1.vm.box = BOX
    nodename1.vm.hostname = "nodename1" + "." + DOMAIN
    nodename1.hostmanager.aliases = %w(nodename1)
    nodename1.vm.network :private_network, :auto_network => true
    #set some machine-specific options  
    nodename1.vm.provider "virtualbox" do |v|
